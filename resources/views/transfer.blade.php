...
<div class="luarbayar">
    <br>
    <br>
    <center><p style:"font-weight: bold;">transfer Berhasil</p></center>
    <div class="dalambayar">
        ...
        <center><p style="margin:10px;">Pastikan untuk tidak menginformasikan bukti dan data pembayaran kepada pihak manapun kecuali Aderim</p></center>
        </div>
        <p style="margin-top:30px;">Transfer pembayaran ke nomor rekening :</p>
        <img src="/bca.png">
        <p>372 177 3939 a/n Aderim</p>
        ...
        <hr width="100%" color="#ededed" align="center">
        <br>
        <p>Nomor Transaksi Anda :</p>
        <p>{{$dataTransaksi->id}}</p>
        <p>Jumlah yang harus dibayar :</p>
        <p style="color:red;">Rp {{ number_format(($dataTransaksi->jumlah*0.25 + $dataTransaksi->kode_token),0,",",".")}}</p>
        ...
        <a style="text-decoration:none;" href={{url('/konfirmasiPembayaran/'.$dataTransaksi->id)}}><div style="margin-top:20px;background-color:#3097d1;border: 1px solid #3097d1;border-radius: 5px;">
